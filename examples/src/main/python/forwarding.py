...
# Change this to point to where you have a copy of the neoscoinj.jar
sys.path.append(r"/path/to/neoscoinj-core-0.12-bundled.jar")
...
if __name__ == "__main__":
    params = org.neoscoinj.params.TestNet3Params.get()
