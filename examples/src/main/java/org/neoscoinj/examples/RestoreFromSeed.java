...
import org.neoscoinj.store.SPVBlockStore;
...
public class RestoreFromSeed {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Neoscoinj supports hierarchical deterministic wallets (or "HD Wallets"): https://github.com/neoscoin/bips/blob/master/bip-0032.mediawiki
        // HD wallets allow you to restore your wallet simply from a root seed. This seed can be represented using a short mnemonic sentence as described in BIP 39: https://github.com/neoscoin/bips/blob/master/bip-0039.mediawiki
        ...
        // You can find some information about this in the guides: https://neoscoinj.github.io/working-with-the-wallet#setup
