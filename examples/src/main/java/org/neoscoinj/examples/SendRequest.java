...
public class SendRequest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // The Coin class represents a monetary Neoscoin value.
        ...
        // The Address class represents a Neoscoin address.
        ...
        // Have a look at the code of the SendRequest class to see what's happening and what other options you have: https://neoscoinj.github.io/javadoc/0.11/com/google/neoscoin/core/Wallet.SendRequest.html
        // 
        ...
        try {
            ...
            // Neoscoinj allows you to define a BalanceFuture to execute a callback once your wallet has a certain balance.
            // Here we wait until the we have enough balance and display a notice.
            // Neoscoinj is using the ListenableFutures of the Guava library. Have a look here for more information: https://code.google.com/p/guava-libraries/wiki/ListenableFutureExplained
