// This file shows how to use neoscoinj from Javascript.
// To run, grab the neoscoinj bundled JAR and then do something like this:
//
//   jjs -cp neoscoinj-0.12-bundled.jar demo.js
//
...
//
//   jjs -cp neoscoinj-0.12-bundled.jar
//
...
//
//   jjs -cp neoscoinj-0.12-bundled.jar:$slf4fj demo.js
//
...
// Nashorn, unlike V8, is thread safe (because it runs on the JVM). And neoscoinj is a threaded library. This means you
