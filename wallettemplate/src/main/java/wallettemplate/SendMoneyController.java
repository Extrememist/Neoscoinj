...
import wallettemplate.controls.NeoscoinAddressValidator;
...
public class SendMoneyController {
    ...
    public void initialize() {
        Coin balance = Main.neoscoin.wallet().getBalance();
        checkState(!balance.isZero());
        new NeoscoinAddressValidator(Main.params, address, sendBtn);
    ...
    public void send(ActionEvent event) {
        ...
        try {
            ...
            req.aesKey = aesKey;
            sendResult = Main.neoscoin.wallet().sendCoins(req);
            ...
            ((HBox)neosLabel.getParent()).getChildren().remove(neosLabel);
            updateTitleForBroadcast();
