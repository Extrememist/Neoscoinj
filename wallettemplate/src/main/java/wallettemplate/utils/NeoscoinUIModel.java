...
/**
 * A class that exposes relevant neoscoin stuff as JavaFX bindable properties.
 */
public class NeoscoinUIModel {
    ...
    public NeoscoinUIModel() {
    }

    public NeoscoinUIModel(Wallet wallet) {
        setWallet(wallet);
    }
