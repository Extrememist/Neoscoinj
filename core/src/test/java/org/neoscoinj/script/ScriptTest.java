...
import org.neoscoinj.script.Script.VerifyFlag;
...
import static org.neoscoinj.script.ScriptOpCodes.OP_0;
import static org.neoscoinj.script.ScriptOpCodes.OP_INVALIDOPCODE;
...
public class ScriptTest {
    ...
    public void createAndUpdateEmptyInputScript() throws Exception {
        ...
        assertThat(inputScript.getChunks().get(0).data, equalTo(dummySig.encodeToNeoscoin()));
        ...
        assertThat(inputScript.getChunks().get(0).opcode, equalTo(OP_0));
        assertThat(inputScript.getChunks().get(1).data, equalTo(dummySig.encodeToNeoscoin()));
        assertThat(inputScript.getChunks().get(2).data, equalTo(dummySig.encodeToNeoscoin()));
        ...
        inputScript = ScriptBuilder.updateScriptWithSignature(inputScript, dummySig.encodeToNeoscoin(), 0, 1, 1);
        assertThat(inputScript.getChunks().get(0).opcode, equalTo(OP_0));
        assertThat(inputScript.getChunks().get(1).data, equalTo(dummySig.encodeToNeoscoin()));
        assertThat(inputScript.getChunks().get(2).opcode, equalTo(OP_0));
        assertThat(inputScript.getChunks().get(3).data, equalTo(multisigScript.getProgram()));

        inputScript = ScriptBuilder.updateScriptWithSignature(inputScript, dummySig.encodeToNeoscoin(), 1, 1, 1);
        assertThat(inputScript.getChunks().get(0).opcode, equalTo(OP_0));
        assertThat(inputScript.getChunks().get(1).data, equalTo(dummySig.encodeToNeoscoin()));
        assertThat(inputScript.getChunks().get(2).data, equalTo(dummySig.encodeToNeoscoin()));
        assertThat(inputScript.getChunks().get(3).data, equalTo(multisigScript.getProgram()));
        ...
        try {
            ScriptBuilder.updateScriptWithSignature(inputScript, dummySig.encodeToNeoscoin(), 1, 1, 1);
