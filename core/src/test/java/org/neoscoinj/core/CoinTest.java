...
public class CoinTest {
    ...
    public void testToFriendlyString() {
        assertEquals("1.00 NEOS", COIN.toFriendlyString());
        assertEquals("1.23 NEOS", valueOf(1, 23).toFriendlyString());
        assertEquals("0.001 NEOS", COIN.divide(1000).toFriendlyString());
        assertEquals("-1.23 NEOS", valueOf(1, 23).negate().toFriendlyString());
    }

    /**
     * Test the neoscoinValueToPlainString amount formatter
     */
    @Test
