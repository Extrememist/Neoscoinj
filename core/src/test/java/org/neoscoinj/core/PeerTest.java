...
import org.neoscoinj.testing.TestWithNetworkConnections;
...
public class PeerTest extends TestWithNetworkConnections {
    ...
    public void badMessage() throws Exception {
        ...
        NeoscoinSerializer serializer = new NeoscoinSerializer(params);
