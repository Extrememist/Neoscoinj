...
import org.neoscoinj.testing.InboundMessageQueuer;
import org.neoscoinj.testing.TestWithPeerGroup;
...
public class FilteredBlockAndPartialMerkleTreeTests extends TestWithPeerGroup {
    ...
    public void deserializeFilteredBlock() throws Exception {
        ...
        assertEquals(block, new FilteredBlock(params, block.neoscoinSerialize()));
    }
    ...
    public void serializeDownloadBlockWithWallet() throws Exception {
        ...
        assertTrue(Arrays.equals(filter.neoscoinSerialize(), HEX.decode("0e1b091ca195e45a9164889b6bc46a09000000efbeadde02")));
        ...
        peerGroup.setUseLocalhostPeerWhenPossible(false); // Prevents from connecting to neoscoin nodes on localhost.
