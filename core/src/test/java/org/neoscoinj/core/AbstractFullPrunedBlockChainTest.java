...
public abstract class AbstractFullPrunedBlockChainTest
{
    ...
    public void testGetOpenTransactionOutputs() throws Exception {
        ...
        // Create neoscoin spend of 1 NEOS.
    ...
    public void testUTXOProviderWithWallet() throws Exception {
        ...
        // Create 1 NEOS spend to a key in this wallet (to ourselves).
        ...
        // Create another spend of 1/2 the value of NEOS we have available using the wallet (store coin selector).
        ...
        // The availbale balance should be the 0 (as we spent the 1 NEOS that's pending) and estimated should be 1/2 - fee NEOS
        assertEquals("Available balance is incorrect", Coin.ZERO, wallet.getBalance(Wallet.BalanceType.AVAILABLE));
