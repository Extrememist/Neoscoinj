...
import static org.neoscoinj.core.Coin.valueOf;
...
public class PeerGroupTest extends TestWithPeerGroup {
    ...
    public void testBloomOnP2Pubkey() throws Exception {
        ...
        assertTrue(p3.lastReceivedFilter.contains(outpoint.neoscoinSerialize()));
    }
    ...
    public void autoRescanOnKeyExhaustion() throws Exception {
        ...
        BloomFilter filter = new BloomFilter(params, p1.lastReceivedFilter.neoscoinSerialize());
