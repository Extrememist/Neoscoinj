...
import org.neoscoinj.wallet.WalletFiles;
...
import static org.neoscoinj.protocols.channels.PaymentChannelCloseException.CloseReason;
import static org.neoscoinj.testing.FakeTxBuilder.createFakeBlock;
import static org.neoscoin.paymentchannel.Protos.TwoWayChannelMessage.MessageType;
...
public class ChannelConnectionTest extends TestWithWallet {
    ...
    private static Wallet roundTripClientWallet(Wallet wallet) throws Exception {
        ...
        org.neoscoinj.wallet.Protos.Wallet proto = WalletProtobufSerializer.parseToProto(new ByteArrayInputStream(bos.toByteArray()));
