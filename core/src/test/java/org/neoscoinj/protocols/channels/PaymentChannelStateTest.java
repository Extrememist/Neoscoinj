...
import static org.neoscoinj.testing.FakeTxBuilder.createFakeTx;
import static org.neoscoinj.testing.FakeTxBuilder.makeSolvedTestBlock;
...
public class PaymentChannelStateTest extends TestWithWallet {
    ...
    public void basic() throws Exception {
        ...
        Transaction refund = new Transaction(params, clientState.getIncompleteRefundTransaction().neoscoinSerialize());
        ...
        Transaction multisigContract = new Transaction(params, clientState.getMultisigContract().neoscoinSerialize());
        ...
        // Both client and server are now in the ready state. Simulate a few micropayments of 0.005 neoscoins.
        Coin size = halfCoin.divide(100);
        Coin totalPayment = Coin.ZERO;
        for (int i = 0; i < 4; i++) {
            byte[] signature = clientState.incrementPaymentBy(size, null).signature.encodeToNeoscoin();
        ...
        final Transaction reserializedCloseTx = new Transaction(params, closeTx.neoscoinSerialize());
    ...
    public void setupDoS() throws Exception {
        ...
        serverState.incrementPayment(CENT.divide(2).subtract(CENT.divide(10)),
                clientState.incrementPaymentBy(CENT.divide(10), null).signature.encodeToNeoscoin());
    ...
    public void checkBadData() throws Exception {
        ...
        byte[] refundTxBytes = clientState.getIncompleteRefundTransaction().neoscoinSerialize();
        ...
        byte[] multisigContractSerialized = clientState.getMultisigContract().neoscoinSerialize();
        ...
        byte[] signature2 = clientState.incrementPaymentBy(halfCoin.subtract(totalPayment), null).signature.encodeToNeoscoin();
    ...
    public void feesTest() throws Exception {
        ...
        byte[] signature = clientState.incrementPaymentBy(Coin.SATOSHI, null).signature.encodeToNeoscoin();
        ...
        serverState.incrementPayment(CENT.subtract(totalPayment), payment.signature.encodeToNeoscoin());
    ...
    public void serverAddsFeeTest() throws Exception {
        ...
        signature = clientState.incrementPaymentBy(SATOSHI.multiply(2), null).signature.encodeToNeoscoin();
    ...
    public void doubleSpendContractTest() throws Exception {
        ...
        doubleSpendContract = new Transaction(params, doubleSpendContract.neoscoinSerialize());
