...
import static org.neoscoinj.core.Coin.CENT;
import static org.neoscoinj.core.Coin.COIN;
import static org.neoscoinj.core.Coin.SATOSHI;
import static org.neoscoinj.core.Coin.ZERO;
...
public class MonetaryFormatTest {
    ...
    private static final MonetaryFormat NO_CODE = MonetaryFormat.NEOS.noCode();
    ...
    @Test
    public void mNeosRounding() throws Exception {
    ...
    @Test
    public void uNeosRounding() throws Exception {
    ...
    public void standardCodes() throws Exception {
        assertEquals("NEOS 0.00", MonetaryFormat.NEOS.format(Coin.ZERO).toString());
        assertEquals("mNEOS 0.00", MonetaryFormat.MNEOS.format(Coin.ZERO).toString());
        assertEquals("µNEOS 0", MonetaryFormat.UNEOS.format(Coin.ZERO).toString());
    }

    @Test
    public void customCode() throws Exception {
        assertEquals("dNEOS 0", MonetaryFormat.UNEOS.code(1, "dNEOS").shift(1).format(Coin.ZERO).toString());
    }

    @Test
    public void codeOrientation() throws Exception {
        assertEquals("NEOS 0.00", MonetaryFormat.NEOS.prefixCode().format(Coin.ZERO).toString());
        assertEquals("0.00 NEOS", MonetaryFormat.NEOS.postfixCode().format(Coin.ZERO).toString());
    }

    @Test
    public void codeSeparator() throws Exception {
        assertEquals("NEOS@0.00", MonetaryFormat.NEOS.codeSeparator('@').format(Coin.ZERO).toString());
    }

    @Test(expected = NumberFormatException.class)
    public void missingCode() throws Exception {
        MonetaryFormat.UNEOS.shift(1).format(Coin.ZERO);
    }
    ...
    public void parse() throws Exception {
        ...
        assertEquals(Coin.MILLICOIN, MonetaryFormat.MNEOS.parse("1"));
        assertEquals(Coin.MILLICOIN, MonetaryFormat.MNEOS.parse("1.0"));
        assertEquals(Coin.MILLICOIN, MonetaryFormat.MNEOS.parse("01.0000000000"));
        assertEquals(Coin.MILLICOIN, MonetaryFormat.MNEOS.positiveSign('+').parse("+1.0"));
        assertEquals(Coin.MILLICOIN.negate(), MonetaryFormat.MNEOS.parse("-1"));
        assertEquals(Coin.MILLICOIN.negate(), MonetaryFormat.MNEOS.parse("-1.0"));

        assertEquals(Coin.MICROCOIN, MonetaryFormat.UNEOS.parse("1"));
        assertEquals(Coin.MICROCOIN, MonetaryFormat.UNEOS.parse("1.0"));
        assertEquals(Coin.MICROCOIN, MonetaryFormat.UNEOS.parse("01.0000000000"));
        assertEquals(Coin.MICROCOIN, MonetaryFormat.UNEOS.positiveSign('+').parse("+1.0"));
        assertEquals(Coin.MICROCOIN.negate(), MonetaryFormat.UNEOS.parse("-1"));
        assertEquals(Coin.MICROCOIN.negate(), MonetaryFormat.UNEOS.parse("-1.0"));
