...
/**
 * Implementation of the <a href="https://github.com/neoscoin/bips/blob/master/bip-0032.mediawiki">BIP 32</a>
...
public final class HDKeyDerivation {
    ...
    public static final HMac MASTER_HMAC_SHA512 = HDUtils.createHmacSha512Digest("Neoscoin seed".getBytes());
    ...
    public static DeterministicKey createMasterPrivateKey(byte[] seed) throws HDDerivationException {
        ...
        // Calculate I = HMAC-SHA512(key="Neoscoin seed", msg=S)
