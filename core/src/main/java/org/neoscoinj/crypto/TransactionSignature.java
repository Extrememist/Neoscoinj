...
package org.neoscoinj.crypto;

import org.neoscoinj.core.ECKey;
import org.neoscoinj.core.Transaction;
import org.neoscoinj.core.VerificationException;
...
/**
 * A TransactionSignature wraps an {@link org.neoscoinj.core.ECKey.ECDSASignature} and adds methods for handling
...
public class TransactionSignature extends ECKey.ECDSASignature {
     ...
     * and generally violates people's mental model of how Neoscoin should work, thus, non-canonical signatures are now
     * not relayed by default.
     */
    public static boolean isEncodingCanonical(byte[] signature) {
        // See reference client's IsCanonicalSignature, https://neoscointalk.org/index.php?topic=8392.msg127623#msg127623
     ...
     * of the type used by Neoscoin we have to encode them using DER encoding, which is just a way to pack the two
     * components into a structure, and then we append a byte to the end for the sighash flags.
     */
    public byte[] encodeToNeoscoin() {
        try {
     ...
     */
    public static TransactionSignature decodeFromNeoscoin(byte[] bytes, boolean requireCanonical) throws VerificationException {
        // Neoscoin encoding is DER signature + sighash byte.
        ...
        // In Neoscoin, any value of the final byte is valid, but not necessarily canonical. See javadocs for
