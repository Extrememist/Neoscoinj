...
package org.neoscoinj.kits;

import com.google.common.collect.*;
import com.google.common.util.concurrent.*;
import com.subgraph.orchid.*;
import org.neoscoinj.core.*;
import org.neoscoinj.net.discovery.*;
import org.neoscoinj.params.*;
import org.neoscoinj.protocols.channels.*;
...
/**
 * <p>Utility class that wraps the boilerplate needed to set up a new SPV neoscoinj app. Instantiate it with a directory
 ...
 * It is to make it easier to fit neoscoinj into GUI apps, which require a high degree of responsiveness on their main
 * thread which handles all the animation and user interaction. Even when blockingStart is false, initializing neoscoinj
...
public class WalletAppKit extends AbstractIdleService {
     ...
     * {@link org.neoscoinj.core.DownloadProgressTracker} is a good choice. This has no effect unless setBlockingStartup(false) has been called
     ...
     * block sync faster for new users - please refer to the documentation on the neoscoinj website for further details.
     */
    ...
    protected void startUp() throws Exception {
        ...
        try {
            ...
            // Initiate Neoscoin network objects (block store, blockchain and peer group)
