...
import static org.neoscoinj.core.Coin.SMALLEST_UNIT_EXPONENT;
...
/**
 * <p>This class, a concrete extension of {@link NeosFormat}, is distinguished in that each
 * instance formats and by-default parses all Neoscoin monetary values in units of a single
 ...
 * custom pattern using either the {@link NeosFormat.Builder#localizedPattern} or {@link NeosFormat.Builder#localizedPattern()} methods, as described in the documentation for the {@link NeosFormat.Builder}
 * class.<ol>
 *
 * <p>A more detailed explanation, including examples, is in the documentation for the
 * {@link NeosFormat} class, and further information beyond that is in the documentation for the
...
public final class NeosFixedFormat extends NeosFormat {
     ...
     *  thet same value expressed in neoscoins. */
    private final int scale;

    /** Constructor */
    protected NeosFixedFormat(
     ...
     * the denomination is millineoscoins, this method will return the value <code>3</code>.  As
     ...
     *  the denomination is millineoscoins, this method will return the value <code>3</code>.  */
    @Override
     ...
     * denomination is millineoscoins, then this method will return <code>"mNEOS"</code>,
     * assuming the default base currency-code is not overridden using a
     * {@link NeosFormat.Builder}.  */
     ...
     * millineoscoins, this method by default returns <code>"₥฿"</code>, depending on the
     * locale.  */
    ...
    @Override public boolean equals(Object o) {
        ...
        if (!(o instanceof NeosFixedFormat)) return false;
        NeosFixedFormat other = (NeosFixedFormat)o;
