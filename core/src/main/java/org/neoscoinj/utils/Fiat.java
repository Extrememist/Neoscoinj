...
public final class Fiat implements Monetary, Comparable<Fiat>, Serializable {
    ...
    /**
     * <p>
     * Returns the value as a plain string denominated in NEOS. The result is unformatted with no trailing zeroes. For
     * instance, a value of 150000 satoshis gives an output string of "0.0015" NEOS
     * </p>
     */
