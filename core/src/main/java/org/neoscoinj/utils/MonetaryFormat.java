...
import org.neoscoinj.core.Monetary;
...
public final class MonetaryFormat {
    ...
    /** Standard format for the NEOS denomination. */
    public static final MonetaryFormat NEOS = new MonetaryFormat().shift(0).minDecimals(2).repeatOptionalDecimals(2, 3);
    /** Standard format for the mNEOS denomination. */
    public static final MonetaryFormat MNEOS = new MonetaryFormat().shift(3).minDecimals(2).optionalDecimals(2);
    /** Standard format for the µNEOS denomination. */
    public static final MonetaryFormat UNEOS = new MonetaryFormat().shift(6).minDecimals(0).optionalDecimals(2);
    /** Standard format for fiat amounts. */
    public static final MonetaryFormat FIAT = new MonetaryFormat().shift(0).minDecimals(2).repeatOptionalDecimals(2, 1);
    /** Currency code for base 1 Neoscoin. */
    public static final String CODE_NEOS = "NEOS";
    /** Currency code for base 1/1000 Neoscoin. */
    public static final String CODE_MNEOS = "mNEOS";
    /** Currency code for base 1/1000000 Neoscoin. */
    public static final String CODE_UNEOS = "µNEOS";
    ...
    private static final String DECIMALS_PADDING = "0000000000000000"; // a few more than necessary for Neoscoin
    ...
    /**
     * Set number of digits to shift the decimal separator to the right, coming from the standard NEOS notation that was
    ...
    public MonetaryFormat() {
        ...
        this.codes.put(0, CODE_NEOS);
        this.codes.put(3, CODE_MNEOS);
        this.codes.put(6, CODE_UNEOS);
        this.codeSeparator = ' ';
    ...
    /**
     * Parse a human readable coin value to a {@link org.neoscoinj.core.Coin} instance.
     * 
    ...
    /**
     * Parse a human readable fiat value to a {@link org.neoscoinj.core.Fiat} instance.
     * 
     * @throws NumberFormatException
     *             if the string cannot be parsed for some reason
     */
