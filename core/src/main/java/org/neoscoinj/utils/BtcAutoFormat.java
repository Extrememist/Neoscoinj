...
/**
 * <p>This class, a concrete extension of {@link NeosFormat}, is distinguished by its
 * accommodation of multiple denominational units as follows:
 *
 * <p>When formatting Neoscoin monetary values, an instance of this class automatically adjusts
 ...
 *
 * <p>When parsing <code>String</code> representations of Neoscoin monetary values, instances of
 ...
 * NeosFormat} class, and further information beyond that is in the documentation for the {@link
...
public final class NeosAutoFormat extends NeosFormat {
    ...
    public enum Style {
        ...
        /** Constant for the formatting style that uses a currency code, e.g., "NEOS". */
        CODE {
    ...
    /** Constructor */
    protected NeosAutoFormat(Locale locale, Style style, int fractionPlaces) {
    ...
    /**
     * Calculate the appropriate denomination for the given Neoscoin monetary value.  This
    ...
    @Override public boolean equals(Object o) {
        ...
        if (!(o instanceof NeosAutoFormat)) return false;
        return super.equals((NeosAutoFormat)o);
    }
