...
import org.neoscoin.crawler.PeerSeedProtos;
 ...
 * This is not currently in use by the Neoscoin community, but rather, is here for experimentation.
 */
public class HttpDiscovery implements PeerDiscovery {
    ...
    public InetSocketAddress[] getPeers(long timeoutValue, TimeUnit timeoutUnit) throws PeerDiscoveryException {
        try {
            ...
            conn.setRequestProperty("User-Agent", "neoscoinj " + VersionMessage.BITCOINJ_VERSION);
