...
package org.neoscoinj.net.discovery;

import org.neoscoinj.core.AddressFormatException;
import org.neoscoinj.core.Base58;
...
public class IrcDiscovery implements PeerDiscovery {
     ...
     * disconnecting.
     *
     * @param channel The IRC channel to join, either "#neoscoin" or "#neoscoinTEST3" for the main and test networks
     *                respectively.
     */
    ...
    public InetSocketAddress[] getPeers(long timeoutValue, TimeUnit timeoutUnit) throws PeerDiscoveryException {
        ...
        try {
            ...
            // neoscoinj but not match the standard nick format, so full peers don't try and connect to us.
