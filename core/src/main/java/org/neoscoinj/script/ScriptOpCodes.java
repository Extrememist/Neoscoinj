...
/**
 * Various constants that define the assembly-like scripting language that forms part of the Neoscoin protocol.
 * See {@link org.neoscoinj.script.Script} for details. Also provides a method to convert them to a string.
 */
