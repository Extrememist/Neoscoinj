 ...
 * convenience methods on {@link org.neoscoinj.core.Transaction}, but they are useful when working with the
...
public class ScriptBuilder {
    ...
    public static Script createInputScript(@Nullable TransactionSignature signature, ECKey pubKey) {
        ...
        byte[] sigBytes = signature != null ? signature.encodeToNeoscoin() : new byte[]{};
    ...
    public static Script createMultiSigInputScript(List<TransactionSignature> signatures) {
        ...
        for (TransactionSignature signature : signatures) {
            sigs.add(signature.encodeToNeoscoin());
        }
     ...
     * <a href="https://github.com/neoscoin/bips/blob/master/bip-0016.mediawiki">BIP 16</a> to learn more about this
     * kind of script.
     */
