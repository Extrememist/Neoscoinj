...
/**
 * The Context object holds various objects that are scoped to a specific instantiation of neoscoinj for a specific
 * network. You can get an instance of this class through {@link AbstractBlockChain#getContext()}. At the momemnt it
 * only contains a {@link org.neoscoinj.core.TxConfidenceTable} but in future it will likely contain file paths and
