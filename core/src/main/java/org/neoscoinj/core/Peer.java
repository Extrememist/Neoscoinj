...
import org.neoscoinj.store.BlockStore;
...
/**
 * <p>A Peer handles the high level communication with a Neoscoin node, extending a {@link PeerSocketHandler} which
 * handles low-level message (de)serialization.</p>
 *
 * <p>Note that timeouts are handled by the extended
 * {@link org.neoscoinj.net.AbstractTimeoutHandler} and timeout is automatically disabled (using
 * {@link org.neoscoinj.net.AbstractTimeoutHandler#setTimeoutEnabled(boolean)}) once the version
...
public class Peer extends PeerSocketHandler {
     ...
     * {@link org.neoscoinj.net.NioClientManager#openConnection(java.net.SocketAddress, org.neoscoinj.net.StreamParser)}
     * or
     * {@link org.neoscoinj.net.NioClient#NioClient(java.net.SocketAddress, org.neoscoinj.net.StreamParser, int)}.</p>
     *
    ...
    /**
     * <p>Construct a peer that reads/writes from the given block chain. Transactions stored in a {@link org.neoscoinj.core.TxConfidenceTable}
    ...
    private void processVersionMessage(VersionMessage m) throws ProtocolException {
        ...
        // neoscoinj is a client mode implementation. That means there's not much point in us talking to other client
        ...
        try {
            ...
            try {
                if (awaitingFreshFilter != null) {
                    ...
                    // range of blocks and get an inv both times, due to the codepath in Neoscoin Core hitting
    ...
    private void blockChainDownloadLocked(Sha256Hash toHash) {
        ...
        //
        //   https://en.neoscoin.it/wiki/Protocol_specification#getblocks
        //
     ...
     * Once the pong is received the value returned by {@link org.neoscoinj.core.Peer#getLastPingTime()} is
     * updated.
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link org.neoscoinj.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link org.neoscoinj.core.Peer#ping()} has never
