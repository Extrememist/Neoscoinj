...
/**
 * <p>A BlockChain implements the <i>simplified payment verification</i> mode of the Neoscoin protocol. It is the right
...
public class BlockChain extends AbstractBlockChain {
     ...
     * </p>
     *
     * <p>For the store, you should use {@link org.neoscoinj.store.SPVBlockStore} or you could also try a
     * {@link org.neoscoinj.store.MemoryBlockStore} if you want to hold all headers in RAM and don't care about
