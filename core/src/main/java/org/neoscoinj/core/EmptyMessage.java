 ...
 * Currently this includes getaddr, verack and special neoscoinj class UnknownMessage.
 */
public abstract class EmptyMessage extends Message {
    ...
    @Override
    final protected void neoscoinSerializeToStream(OutputStream stream) throws IOException {
    }
