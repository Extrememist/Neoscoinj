...
/**
 * <p>Methods to serialize and de-serialize messages to the Neoscoin network format as defined in
 * <a href="https://en.neoscoin.it/wiki/Protocol_specification">the protocol specification</a>.</p>
 *
 ...
 * <li>Message.neoscoinSerializeToStream() needs to be properly subclassed</li>
 * </ul>
 */
public class NeoscoinSerializer {
    private static final Logger log = LoggerFactory.getLogger(NeoscoinSerializer.class);
    ...
    /**
     * Constructs a NeoscoinSerializer with the given behavior.
     *
     * @param params           networkParams used to create Messages instances and termining packetMagic
     */
    public NeoscoinSerializer(NetworkParameters params) {
     ...
     */
    public NeoscoinSerializer(NetworkParameters params, boolean parseLazy, boolean parseRetain) {
        this.params = params;
    ...
    public void serialize(Message message, OutputStream out) throws IOException {
        ...
        if (name == null) {
            throw new Error("NeoscoinSerializer doesn't currently know how to serialize " + message.getClass());
        }
        serialize(name, message.neoscoinSerialize(), out);
    }
    ...
    public Message deserialize(ByteBuffer in) throws ProtocolException, IOException {
        // A Neoscoin protocol message has the following format.
        //
        ...
        NeoscoinPacketHeader header = new NeoscoinPacketHeader(in);
     ...
     */
    public NeoscoinPacketHeader deserializeHeader(ByteBuffer in) throws ProtocolException, IOException {
        return new NeoscoinPacketHeader(in);
    }

    /**
     * Deserialize payload only.  You must provide a header, typically obtained by calling
     * {@link NeoscoinSerializer#deserializeHeader}.
     */
    public Message deserializePayload(NeoscoinPacketHeader header, ByteBuffer in) throws ProtocolException, BufferUnderflowException {
    ...
    public static class NeoscoinPacketHeader {
        ...
        public NeoscoinPacketHeader(ByteBuffer in) throws ProtocolException, BufferUnderflowException {
