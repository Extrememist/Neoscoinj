/*
 * Copyright 2014 the neoscoinj authors
 *
...
/**
 * This command is supported only by <a href="http://github.com/neoscoinxt/neoscoinxt">Neoscoin XT</a> nodes, which
...
public class GetUTXOsMessage extends Message {
    ...
    void neoscoinSerializeToStream(OutputStream stream) throws IOException {
        ...
        for (TransactionOutPoint outPoint : outPoints) {
            outPoint.neoscoinSerializeToStream(stream);
        }
    }
