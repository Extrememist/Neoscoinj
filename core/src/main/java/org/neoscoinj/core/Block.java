...
import static org.neoscoinj.core.Coin.FIFTY_COINS;
import static org.neoscoinj.core.Utils.doubleDigest;
import static org.neoscoinj.core.Utils.doubleDigestTwoBuffers;

/**
 * <p>A block is a group of transactions, and is one of the fundamental data structures of the Neoscoin system.
 ...
 * <a href="http://www.neoscoin.org/neoscoin.pdf">the Neoscoin technical paper</a> for
...
public class Block extends Message {
     ...
     * upgrade everyone to change this, so Neoscoin can continue to grow. For now it exists as an anti-DoS measure to
    ...
    /** Constructs a block object from the Neoscoin wire format. */
    ...
    /**
     * Contruct a block object from the Neoscoin wire format.
    ...
    /**
     * <p>A utility method that calculates how much new Neoscoin would be created by the block at the given height.
     * The inflation of Neoscoin is predictable and drops roughly every 4 years (210,000 blocks). At the dawn of
     * the system it was 50 coins per block, in late 2012 it went to 25 coins per block, and so on. The size of
     * a coinbase transaction is inflation plus fees.</p>
     *
     * <p>The half-life is controlled by {@link org.neoscoinj.core.NetworkParameters#getSubsidyDecreaseBlockCount()}.
     * </p>
     */
    ...
    public int getOptimalEncodingMessageSize() {
        ...
        if (optimalEncodingMessageSize != 0)
            return optimalEncodingMessageSize;
        optimalEncodingMessageSize = neoscoinSerialize().length;
        return optimalEncodingMessageSize;
    }
    ...
    /** Returns the version of the block data structure as defined by the Neoscoin protocol. */
     ...
     * {@link org.neoscoinj.core.Block#getDifficultyTargetAsInteger()}. Note that this is <b>not</b> the same as
     * the difficulty value reported by the Neoscoin "getdifficulty" RPC that you may see on various block explorers.
    ...
    void addCoinbaseTransaction(byte[] pubKeyTo, Coin value) {
        ...
        coinbase.length = coinbase.neoscoinSerialize().length;
    ...
    /**
     * Create a block sending 50NEOS as a coinbase transaction to the public key specified.
