...
public class TransactionOutput extends ChildMessage implements Serializable {
    ...
    // These fields are Java serialized but not Neoscoin serialized. They are used for tracking purposes in our wallet
    ...
    /**
     * <p>If the output script pays to an address as in <a href="https://neoscoin.org/en/developer-guide#term-p2pkh">
     ...
     * the redeem script.</p>
     *
     * <p>P2SH is described by <a href="https://github.com/neoscoin/bips/blob/master/bip-0016.mediawiki">BIP 16</a> and
     * <a href="https://neoscoin.org/en/developer-guide#p2sh-scripts">documented in the Neoscoin Developer Guide</a>.</p>
     *
     * @param networkParameters needed to specify an address
     ...
     * consume more than a third of its value in fees is not something the Neoscoin system wants to deal with right now,
     * so we call them "dust outputs" and they're made non standard. The choice of one third is somewhat arbitrary and
     * may change in future.</p>
     *
     * <p>You probably should use {@link org.neoscoinj.core.TransactionOutput#getMinNonDustValue()} which uses
    ...
    public Coin getMinNonDustValue(Coin feePerKbRequired) {
        ...
        final long size = this.neoscoinSerialize().length + 148;
