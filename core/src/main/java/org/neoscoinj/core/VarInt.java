...
import static org.neoscoinj.core.Utils.isLessThanUnsigned;
import static org.neoscoinj.core.Utils.isLessThanOrEqualToUnsigned;
...
public class VarInt {
    ...
    // Neoscoin has its own varint format, known in the C++ source as "compact size".
