...
public class VersionMessage extends Message {
    ...
    /**
     * User-Agent as defined in <a href="https://github.com/neoscoin/bips/blob/master/bip-0014.mediawiki">BIP 14</a>.
     ...
     * See <a href="https://github.com/neoscoin/bips/blob/master/bip-0037.mediawiki#extensions-to-existing-messages">BIP 37</a>.
     */
    ...
    public static final String LIBRARY_SUBVER = "/neoscoinj:" + BITCOINJ_VERSION + "/";
    ...
    @Override
    public void neoscoinSerializeToStream(OutputStream buf) throws IOException {
        ...
        try {
            // My address.
            myAddr.neoscoinSerialize(buf);
            // Their address.
            theirAddr.neoscoinSerialize(buf);
        } catch (UnknownHostException e) {
     ...
     *
     * See <a href="https://github.com/neoscoin/bips/blob/master/bip-0014.mediawiki">BIP 14</a> for more information.
     *
