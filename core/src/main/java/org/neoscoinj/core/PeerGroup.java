...
import org.neoscoinj.crypto.DRMWorkaround;
import org.neoscoinj.net.BlockingClientManager;
import org.neoscoinj.net.ClientConnectionManager;
import org.neoscoinj.net.FilterMerger;
import org.neoscoinj.net.NioClientManager;
import org.neoscoinj.net.discovery.PeerDiscovery;
import org.neoscoinj.net.discovery.PeerDiscoveryException;
import org.neoscoinj.net.discovery.TorDiscovery;
import org.neoscoinj.script.Script;
import org.neoscoinj.utils.DaemonThreadFactory;
import org.neoscoinj.utils.ExponentialBackoff;
...
public class PeerGroup implements TransactionBroadcaster {
     ...
     * <a href="https://github.com/neoscoin/bips/blob/master/bip-0014.mediawiki">BIP 14</a>.
     *
     ...
     *         Use {@link org.neoscoinj.core.Peer#getConnectionOpenFuture()} if you
    ...
    /**
     * Use {@link org.neoscoinj.core.Context#getConfidenceTable()} instead, which can be retrieved via
     * {@link org.neoscoinj.core.AbstractBlockChain#getContext()}. Can return null if this peer group was
     ...
     * peers. By using this with {@link org.neoscoinj.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link org.neoscoinj.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link org.neoscoinj.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * someone and want to know that it's valid. It's a bit of a weird hack because the current version of the Neoscoin
     ...
     * times are available via {@link org.neoscoinj.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link org.neoscoinj.core.Peer#ping()}.
     */
    ...
    /**
     * When true (the default), PeerGroup will attempt to connect to a Neoscoin node running on localhost before
     * attempting to use the P2P network. If successful, only localhost will be used. This makes for a simple
     * and easy way for a user to upgrade a neoscoinj based app running in SPV mode to fully validating security.
     */
