...
public class TransactionOutPoint extends ChildMessage implements Serializable {
    ...
    // This is not part of Neoscoin serialization. It's included in Java serialization.
     ...
     * For P2SH scripts you can use {@link #getConnectedRedeemData(org.neoscoinj.wallet.KeyBag)} and then get the
     * key from RedeemData.
