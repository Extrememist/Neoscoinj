...
import org.neoscoinj.protocols.channels.PaymentChannelCloseException.CloseReason;
...
public class PaymentChannelClient implements IPaymentChannelClient {
     ...
     *                   See {@link org.neoscoinj.protocols.channels.IPaymentChannelClient.ClientConnection#acceptExpireTime(long)}
    ...
    private CloseReason receiveInitiate(Protos.Initiate initiate, Coin contractValue, Protos.Error.Builder errorBuilder)
        ...
        Protos.ProvideRefund.Builder provideRefundBuilder = Protos.ProvideRefund.newBuilder()
                ...
                .setTx(ByteString.copyFrom(state.getIncompleteRefundTransaction().neoscoinSerialize()));
    ...
    private void receiveRefund(Protos.TwoWayChannelMessage refundMsg, @Nullable KeyParameter userKey) throws VerificationException {
        ...
        Protos.ProvideContract.Builder contractMsg = Protos.ProvideContract.newBuilder()
                .setTx(ByteString.copyFrom(state.getMultisigContract().neoscoinSerialize()));
        try {
            ...
            initialMsg.setSignature(ByteString.copyFrom(payment.signature.encodeToNeoscoin()));
     ...
     * {@link ClientConnection#destroyConnection(org.neoscoinj.protocols.channels.PaymentChannelCloseException.CloseReason)} or
