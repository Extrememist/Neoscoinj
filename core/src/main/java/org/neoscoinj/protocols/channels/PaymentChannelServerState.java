 ...
 * <i>server</i> or <i>receiving party</i>. Although the underlying Neoscoin protocol is capable of more complex
...
public class PaymentChannelServerState {
    ...
    private void signMultisigInput(Transaction tx, Transaction.SigHash hashType, boolean anyoneCanPay) {
        ...
        byte[] mySig = signature.encodeToNeoscoin();
