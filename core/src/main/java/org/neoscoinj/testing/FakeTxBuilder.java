...
public class FakeTxBuilder {
    ...
    /**
     * Transaction[0] is a feeder transaction, supplying NEOS to Transaction[1]
     */
    public static Transaction[] createFakeTx(NetworkParameters params, Coin value,
                                             Address to, Address from) {
        // Create fake TXes of sufficient realism to exercise the unit tests. This transaction send NEOS from the
    ...
    public static Transaction roundTripTransaction(NetworkParameters params, Transaction tx) {
        try {
            NeoscoinSerializer bs = new NeoscoinSerializer(params);
    ...
    public static DoubleSpends createFakeDoubleSpendTxns(NetworkParameters params, Address to) {
        ...
        try {
            doubleSpends.t1 = new Transaction(params, doubleSpends.t1.neoscoinSerialize());
            doubleSpends.t2 = new Transaction(params, doubleSpends.t2.neoscoinSerialize());
