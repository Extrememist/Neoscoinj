...
import org.neoscoinj.crypto.ChildNumber;
import org.neoscoinj.crypto.DeterministicKey;
import org.neoscoinj.crypto.KeyCrypter;
import org.neoscoinj.crypto.LinuxSecureRandom;
...
/**
 * <p>A KeyChainGroup is used by the {@link org.neoscoinj.core.Wallet} and
...
public class KeyChainGroup implements KeyBag {
     ...
     *
     * @throws org.neoscoinj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     * KeyCrypter to use is {@link org.neoscoinj.crypto.KeyCrypterScrypt}.
     *
     * @throws org.neoscoinj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
