/**
 * Copyright 2014 The neoscoinj developers.
 *
...
package org.neoscoinj.wallet;

import org.neoscoinj.core.BloomFilter;
import org.neoscoinj.core.ECKey;
import org.neoscoinj.core.NetworkParameters;
import org.neoscoinj.core.Utils;
 ...
 * <a href="https://github.com/neoscoin/bips/blob/master/bip-0032.mediawiki">BIP 32 standard</a>, as implemented by
 * {@link org.neoscoinj.crypto.DeterministicHierarchy}, to derive all the keys in the keychain from a master seed.
 ...
 * written down on paper or, when represented using a BIP 39 {@link org.neoscoinj.crypto.MnemonicCode},
 ...
 * {@link org.neoscoinj.crypto.DeterministicKey#serializePubB58()}. The resulting "xpub..." string encodes
 * sufficient information about the account key to create a watching chain via
 * {@link org.neoscoinj.crypto.DeterministicKey#deserializeB58(org.neoscoinj.crypto.DeterministicKey, String)}
 * (with null as the first parameter) and then
 * {@link DeterministicKeyChain#DeterministicKeyChain(org.neoscoinj.crypto.DeterministicKey)}.</p>
 *
 * <p>This class builds on {@link org.neoscoinj.crypto.DeterministicHierarchy} and
 * {@link org.neoscoinj.crypto.DeterministicKey} by adding support for serialization to and from protobufs,
...
public class DeterministicKeyChain implements EncryptableKeyChain {
    ...
    public List<DeterministicKey> getKeys(KeyPurpose purpose, int numberOfKeys) {
        ...
        try {
            ...
            for (int i = 0; i < numberOfKeys; i++) {
                ...
                // by any real problem reports from neoscoinj users, but I've heard of cases via the grapevine of
     ...
     * The returned key can be serialized and then passed into {@link #watch(org.neoscoinj.crypto.DeterministicKey)}
     ...
     * @see org.neoscoinj.wallet.MarriedKeyChain
     */
