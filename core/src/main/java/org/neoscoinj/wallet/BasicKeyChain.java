...
public class BasicKeyChain implements EncryptableKeyChain {
     ...
     * @throws org.neoscoinj.store.UnreadableWalletException.BadPassword if the password doesn't seem to match
     * @throws org.neoscoinj.store.UnreadableWalletException if the data structures are corrupted/inconsistent
     */
    ...
    /**
     * Convenience wrapper around {@link #toEncrypted(org.neoscoinj.crypto.KeyCrypter,
    ...
    public BasicKeyChain toEncrypted(KeyCrypter keyCrypter, KeyParameter aesKey) {
        ...
        try {
            ...
            for (ECKey key : hashToKeys.values()) {
                ...
                // (all neoscoin controlled by that private key is lost forever).
